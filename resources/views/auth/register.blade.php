    ...
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="employee_id" class="block text-sm font-medium text-gray-700">Employee ID (optional)</label>
                    <input id="employee_id" name="employee_id" type="text" class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('employee_id') }}">
                </div>
                <div>
